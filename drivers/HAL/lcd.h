 ...
 */
#define LCD_GPIO_DATA_PERIPH 		SYSCTL_PERIPH_GPIOC
#define LCD_GPIO_CTL_PERIPH 		SYSCTL_PERIPH_GPIOA
#define LCD_GPIO_DATA_BASE 			GPIO_PORTC_AHB_BASE  // port for sending data
#define LCD_GPIO_CTL_BASE 			GPIO_PORTA_AHB_BASE  // port for controlling RS, RW and E
